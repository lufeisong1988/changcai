...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    // modules
    protected InputPanel inputPanel;//底部输入框view
    ...
    public boolean onBackPressed() {
        LogUtil.d("inputPanel","onBackPressed");
    ...
    private void parseIntent() {
        ...
        Boolean onlineAble = getArguments().getBoolean(Extras.EXTRA_ONLINE,true);
        ...
        //设置底部inputPanel是否可见
        if(onlineAble){
            inputPanel.setVisiable(true);
        }else{
            inputPanel.setVisiable(false);
        }
