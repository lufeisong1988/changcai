...
public class NimUIKit {
     ...
     *
     * @param context       上下文
     * @param contactIds    聊天对象ID（用户帐号account或者群组ID）
     * @param anchor        跳转到指定消息的位置，不需要跳转填null
     */
    public static void startP2MChatting(Context context, ArrayList<String> contactIds, IMMessage anchor){
        NimUIKitImpl.startP2MChatting(context,contactIds,anchor);
    }
    /**
     * 打开联系人选择器
     *
