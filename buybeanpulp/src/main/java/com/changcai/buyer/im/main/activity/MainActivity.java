...
import com.changcai.buyer.im.avchat.activity.AVChatActivity;
import com.changcai.buyer.im.config.preference.UserPreferences;
import com.changcai.buyer.im.contact.activity.AddFriendActivity;
import com.changcai.buyer.im.login.LoginActivity;
import com.changcai.buyer.im.login.LogoutHelper;
import com.changcai.buyer.im.main.fragment.HomeFragment;
import com.changcai.buyer.im.main.model.Extras;
import com.changcai.buyer.im.session.SessionHelper;
import com.changcai.buyer.im.team.TeamCreateHelper;
import com.changcai.buyer.im.team.activity.AdvancedTeamSearchActivity;
...
public class MainActivity extends UI {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.about://设置
//                LogUtil.d("onlineStatus","getDetailDisplay = " + NimUIKit.getOnlineStateContentProvider().getDetailDisplay("lufeisong6"));
//                LogUtil.d("onlineStatus","getSimpleDisplay = " + NimUIKit.getOnlineStateContentProvider().getSimpleDisplay("lufeisong6"));
//                NimUIKitImpl.getOnlineStateContentProvider().getDetailDisplay("lufeisong6");
//                NimUIKitImpl.getOnlineStateContentProvider().getDetailDisplay("lufeisongb");
//                NimUIKitImpl.getOnlineStateChangeObservable().registerOnlineStateChangeListeners(onlineStateChangeObserver, true);
//                startActivity(new Intent(MainActivity.this, SettingsActivity.class));
                contractIds.add("lufeisongb");
                contractIds.add("lufeisonga");
                contractIds.add("lufeisong4");
                contractIds.add("lufeisong5");
                contractIds.add("lufeisong6");
//                SessionHelper.startP2MSession(this, contractIds,null);
                break;
