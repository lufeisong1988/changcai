package com.changcai.buyer.im.session;
...
import com.changcai.buyer.im.session.activity.MessageHistoryActivity;
import com.changcai.buyer.im.session.activity.MessageInfoActivity;
import com.changcai.buyer.im.session.extension.CustomAttachParser;
import com.changcai.buyer.im.session.extension.CustomAttachment;
...
import com.changcai.buyer.im.session.search.SearchMessageActivity;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderAVChat;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderDefCustom;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderFile;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderGuess;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderOpenRedPacket;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderRTS;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderRedPacket;
import com.changcai.buyer.im.session.viewholder.MsgViewHolderSnapChat;
...
public class SessionHelper {
    ...
    //打开单人面对多顾问的聊天界面(jugg自定义的界面)
    public static void startP2MSession(Context context, ArrayList<GetCounselorsModel.InfoBean> infoBeens, IMMessage anchor){
//        NimUIKit.startP2MChatting(context,contactIds,anchor);
        P2MMessageActivity.start(context,infoBeens,getP2pCustomization(),anchor);
    }
