package com.changcai.buyer.im.session.viewholder;
...
import com.changcai.buyer.im.file.FileIcons;
import com.changcai.buyer.im.session.activity.FileDownloadActivity;
