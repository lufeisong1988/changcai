...
import com.changcai.buyer.im.contact.ContactHttpClient;
import com.changcai.buyer.im.main.activity.MainActivity;
...
//        final String account = "helloworld";
        final String account = loginAccountEdit.getEditableText().toString().toLowerCase();
//        final String token = "95e014257d0f9e69857681e10852c1e7";
