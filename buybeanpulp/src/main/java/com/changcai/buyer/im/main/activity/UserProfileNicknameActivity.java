...
public class UserProfileNicknameActivity extends CompatTouchBackActivity {
    ...
    protected int getTitleText() {
        return R.string.user_profile_nickname;
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_user_profile_nickname;
    }
    ...
    RequestCallbackWrapper callback = new RequestCallbackWrapper() {
        ...
        public void onResult(int code, Object result, Throwable exception) {
            ...
            if (code == ResponseCode.RES_SUCCESS) {
                ...
                Toast.makeText(UserProfileNicknameActivity.this, R.string.user_info_update_failed, Toast.LENGTH_SHORT).show();
            }
        }
    };
    private void onUpdateCompleted() {
        showKeyboard(false);
        Toast.makeText(UserProfileNicknameActivity.this, R.string.user_info_update_success, Toast.LENGTH_SHORT).show();
        finish();
    }
