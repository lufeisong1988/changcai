package com.changcai.buyer.view.indicator.circlenavigator;
...
import com.changcai.buyer.view.indicator.IPagerNavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = AndroidUtil.dip2px(context, 3);
        mCircleSpacing = AndroidUtil.dip2px(context, 8);
        mStrokeWidth = AndroidUtil.dip2px(context, 1);
    }
