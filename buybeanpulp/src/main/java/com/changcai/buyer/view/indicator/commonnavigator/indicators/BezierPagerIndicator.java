package com.changcai.buyer.view.indicator.commonnavigator.indicators;
...
import com.changcai.buyer.view.indicator.ArgbEvaluatorHolder;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = AndroidUtil.dip2px(context, 3.5f);
        mMinCircleRadius = AndroidUtil.dip2px(context, 2f);
        mYOffset = AndroidUtil.dip2px(context, 1.5f);
    }
