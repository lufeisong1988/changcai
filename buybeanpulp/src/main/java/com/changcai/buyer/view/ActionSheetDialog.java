...
public class ActionSheetDialog {
	...
	private void setSheetItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			if (size == 1) {
				...
				if (showTitle) {
					if (i < (size -1)) {
						...
						textView.setBackgroundResource(R.drawable.actionsheet_middle_with_bottom_line);
					} else {
						textView.setBackgroundResource(R.drawable.actionsheet_bottom);
					}
				} else {
			...
			int height = context.getResources().getDimensionPixelSize(R.dimen.dim114);
	...
	public enum SheetItemColor {
		Blue("#037BFF"), GRAY("#9FA4AB"),BLACK("#252729");
