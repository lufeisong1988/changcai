...
public class WrapPagerIndicator extends View implements IPagerIndicator {
    ...
    public void setDrawBitmap(Bitmap mDrawBitmap) {
        ninePatch = new NinePatch(mDrawBitmap, mDrawBitmap.getNinePatchChunk(), null);
    }
    ...
    private void init(Context context) {
        ...
        mVerticalPadding = AndroidUtil.dip2px(context, 6);
        mHorizontalPadding = AndroidUtil.dip2px(context, 10);
    }
