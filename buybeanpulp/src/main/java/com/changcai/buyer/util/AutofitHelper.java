...
public class AutofitHelper {
    ...
    public static AutofitHelper create(TextView view) {
        ...
        helper.setMinTextSize(TypedValue.COMPLEX_UNIT_PX, DEFAULT_MIN_TEXT_SIZE)
     ...
     */
    public static float getFitTextSize(TextView view, CharSequence text,float maxTextSize,
            int maxLines) {
        ...
        paint.setTextSize(maxTextSize / 4);
        int targetWidth = view.getWidth() - view.getPaddingLeft() - view.getPaddingRight() - (int) paint.measureText("天时", 0, 2);
        if (targetWidth <= 0) {
            return DEFAULT_MIN_TEXT_SIZE;
        }
