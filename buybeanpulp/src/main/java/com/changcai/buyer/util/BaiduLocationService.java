...
/**
 * Created by liuxingwei on 2017/1/18.
 */
...
public class BaiduLocationService {
    ...
    private static BaiduLocationService instance = null;

    private BaiduLocationService() {

        mLocationClient = new LocationClient(CommonApplication.getInstance());     //声明LocationClient类
