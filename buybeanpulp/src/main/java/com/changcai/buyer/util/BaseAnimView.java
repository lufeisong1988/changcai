...
/**
 * Created by liuxingwei on 2017/6/27.
 */
...
public class BaseAnimView {
    ...
    public static Animation FadingIn() {
        ...
        alphaAnim.setDuration(longAnimDuration);
        return alphaAnim;
    }
    ...
    public static Animation ScaleBig(Interpolator inter) {
        scaleAnim = new ScaleAnimation(0.9f, 1.0f, 0.9f, 1.0f,
    ...
    public static Animation ScaleToBigVerticalIn(Interpolator inter,float percentStartY) {
        scaleAnim = new ScaleAnimation(1.0f, 1.0f, 0f, 1.0f,
